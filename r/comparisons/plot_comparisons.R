...
epsilon.results <- read.csv("epsilongreedy_results.tsv", sep="\t", header = FALSE)
...
# Annealing Softmax
# annealing.softmax.results <- read.csv("annealing_softmax_results.tsv", header = FALSE)
...
# Exp3
# exp3.results <- read.csv("exp3_results.tsv", header = FALSE)
...
results <- rbind(annealing.results, epsilon.results, ucb1.results)
